var includes = {
        camelcase: require('./includes/camelcase')
      , enderFake: require('./includes/enderFake')
      , extend: require('./includes/extend')
      , map: require('./includes/map').map
      , $map: require('./includes/map').$map
      , on: require('./includes/on')
      , proxy: require('./includes/proxy')
    }
